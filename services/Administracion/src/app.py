...
def create_app():
    ...
    app.register_blueprint(restaurantes_bp, url_prefix='/api/admin/restaurantes')
    app.register_blueprint(sucursales_bp, url_prefix='/api/admin/sucursales')
    app.register_blueprint(mesas_bp, url_prefix='/api/admin/mesas')
    app.register_blueprint(horarios_bp, url_prefix='/api/admin/horarios')
    app.register_blueprint(promociones_bp, url_prefix='/api/admin/promociones')
