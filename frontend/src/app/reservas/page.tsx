...
export default function ReservasPage() {
  ...
  const handleReserve = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Error al conectar con el servicio de reservas (Puerto 5002)');
      console.error(error);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen bg-base-200 p-4 md:p-10">
      <div className="max-w-4xl mx-auto bg-base-100 shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          {/* PASO 1: SELECCIONAR SUCURSAL Y PERSONAS */}
          {step === 1 && (
          ...
          {step === 2 && (
            <div className="flex flex-col md:flex-row gap-8 animate-fade-in">
              ...
              <div className="flex-1">
                ...
                {!time && <p className="text-error text-sm mt-2">Selecciona una hora.</p>}
